...
| 웹 프론트엔드 | ✅ (라이브 대시보드 /dashboard.html) |
...
- [x] 라이브 웹 대시보드 — `site/dashboard.html` (Chart.js, 빌드 타임 DB 스냅샷, 다크 사이드바, 4개 차트 + ETL 테이블)
- [x] Azure Static Web Apps 배포 — https://www.dba-azure.techcloudup.com/dashboard.html ✅ 라이브
